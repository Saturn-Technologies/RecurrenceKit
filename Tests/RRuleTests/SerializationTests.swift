...
final class SerializationTests: XCTestCase {
    ...
    func testRRuleSerialization() {
        let components = DateComponents(timeZone: TimeZone(identifier: "GMT")!,
                                        year: 2010,
                                        month: 1,
                                        day: 1)
    ...
    func testDTStartSerialization() {
        let components = DateComponents(timeZone: TimeZone(identifier: "America/New_York")!,
                                        year: 1997,
                                        month: 9,
                                        day: 2,
                                        hour: 09)
    ...
    func testDTStartSerializationNoTimeZone() {
        let components = DateComponents(timeZone: nil,
                                        year: 1997,
                                        month: 9,
                                        day: 2,
                                        hour: 09)
    ...
    func testSetSerializationUTC() {
        ...
        let set = RRuleSet(start: DTStart(components: components),
